...
<h2>주요 기능</h2>
1. 색상 추천 및 color plus 소개
2. 색과 색을 섞을 수 있다
3. 색을 좀 더 디테일하게 조절하며 선택할 수 있다.
4. 추천 그라데이션 및 그라데이션을 커스텀할 수 있다.
5. Box shadow를 커스텀 할 수 있다.
6. 색상 harmony 규칙을 적용해서 유사색,단색,삼각형,보색,등을 볼 수 있다.
7. Add...
<h2>부가 기능</h2>
1. 추천 색상을 클릭할시 css 코드를 복사함
2. 색상 리모콘으로 색이름을 검색해서 rgb나 hex값을 얻을 수 있다.
3. Add ...
<h2>Demo Img</h2>
